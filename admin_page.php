...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $total_pendings = 0;
            $select_pending = mysqli_query($connect, "SELECT total_price FROM `orders` WHERE payment_status = 'pending'") or die('query failed');
      ...
      <div class="box">
         <?php
            $total_completed = 0;
            $select_completed = mysqli_query($connect, "SELECT total_price FROM `orders` WHERE payment_status = 'completed'") or die('query failed');
      ...
      <div class="box">
         <?php 
            $select_messages = mysqli_query($connect, "SELECT * FROM `message`") or die('query failed');
