...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      if($pass != $cpass){
         ...
         mysqli_query($connect, "INSERT INTO `users`(id, name, email, password, user_type) VALUES('$id', '$name', '$email', '$cpass', '$user_type')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post">
      <h3>register now</h3>
      <input type="text" name="id" placeholder="enter your id" required class="box">
