...
if(isset($_POST['update_cart'])){
   ...
   mysqli_query($connect, "UPDATE `cart` SET quantity = '$cart_quantity' WHERE id = '$cart_id'") or die('query failed');
   $message[] = 'cart quantity updated!';
}

if(isset($_GET['delete'])){
   $delete_id = $_GET['delete'];
   mysqli_query($connect, "DELETE FROM `cart` WHERE id = '$delete_id'") or die('query failed');
...
<div class="heading">
   <h3>shopping cart</h3>
   <p> <a href="about.php">home</a> / cart </p>
</div>
