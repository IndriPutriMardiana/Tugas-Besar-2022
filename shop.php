...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <div class="price">Rp <?php echo $fetch_products['price']; ?>,-</div><hr>
                  <font size="3">Penerbit <?php echo $fetch_products['publisher']; ?></font><hr>
                  <font size="3">Penulis <?php echo $fetch_products['writer']; ?></font><hr>
                  <font size="3">Genre <?php echo $fetch_products['genre']; ?></font><hr>
