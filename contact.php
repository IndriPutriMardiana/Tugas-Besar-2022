...
if(isset($_POST['send'])){
   ...
   if(mysqli_num_rows($select_message) > 0){
      ...
      mysqli_query($connect, "INSERT INTO `message`( name, email, number, message) VALUES('$name', '$email', '$number', '$msg')") or die('query failed');
...
<section class="contact">
   ...
   <form action="" method="post">
      <h3>say something!</h3>
      <h4>Kirimkan kami pesan! Kami senang kok membaca pesan dari kaliann.</h4>
